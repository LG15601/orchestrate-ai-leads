      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-accent-success rounded-lg flex items-center justify-center border-2 border-black shadow-[2px_2px_0px_#000000]">
              <Bot className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-black">Orchestra Connect</h1>
              <p className="text-xs text-black/60 font-medium">Agents IA Sur-Mesure</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button 
              ...
              className="text-black font-medium hover:text-accent-success transition-colors duration-200"
            >
              Audit Gratuit
            </button>
            <button 
          ...
          <div className="hidden md:flex items-center gap-4">
            <Button 
              onClick={() => scrollToSection('audit-form')}
              className="bg-accent-success text-white hover:bg-accent-success/90 font-bold text-sm px-6 py-2 border-2 border-black shadow-[2px_2px_0px_#000000] hover:shadow-[4px_4px_0px_#000000] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all duration-200"
            >
              Commencer l'Audit
